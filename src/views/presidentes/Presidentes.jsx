        ...
        <section class="content">
                        <div class="invoice">
                            ...
                            <div class="row">
                                ...
                                <td> 15111 </td>
                                <td> 10148699<br/>RAMOS REYES, JORGE ENRIQUE </td>
                                <td> 01/10/2022 </td>
                                <td> 31/10/2022 </td>
                                <td> AGRONÓMICA </td>
                                <td> <span class="badge btn-info">ACTIVO</span> </td>
                                <td class="text-center"> <button class="btn btn-warning btn-xs" title="Editar" onclick="openUpdateModalPresidente(1 )"><i class="fa fa-edit" style={{fontsize:'25px'}}></i></button> </td>
                                <td class="text-center"> <button class="btn btn-danger btn-xs" title="Eliminar" onclick="deleteModalPresidente(1)"><i class="fa fa-trash" style={{fontsize:'25px'}}></i></button> </td>
                                </tr></tbody>
                                        </table>
                                    </div>
