...
const CHabilidad = () => {
    return (
        <div>
            <div>
                <h5>Certificado de Habilidad<small>Lista</small></h5>
            </div>
                    ...
                    <table className="table table-borderless table-danger" style={{ borderWidth: '1px', borderStyle: 'dashed', borderColor: '#E31E25' }} >
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style={{ color: '#b72928' }}>Asunto</th>
                                <th scope="col" style={{ color: '#b72928' }}>Entidad</th>
                                <th scope="col" style={{ color: '#b72928' }}>Lugar</th>
                                <th scope="col" style={{ color: '#b72928' }}>Fecha de Pago</th>
                                <th scope="col" style={{ color: '#b72928' }}>Fecha de Venc.</th>
                            </tr>
                        </thead>
